      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-6">
            <div className="card card-success">
              <div className="card-header">
                <h3 className="card-title">Seleccione el Escenario para Editar (haga click)</h3>
              </div>
          ...
          <div className="col-md-6">
            <section className="content">
              <div className="container-fluid">
                <div className={escenario.nombre_escenario? 'card card-danger' : 'card card-info' } >
                  <div className="card-header">
                    <h3 className="card-title">
                      Formulario de Datos: {escenario.nombre_escenario? `Editar ${escenario.nombre_escenario}`: 'Nuevo registro'}
                    </h3>
                  </div>
                    ...
                    <div className="card-body">
                      ...
                      <div className="form-group">
                        <label htmlFor="escenario">
                          Elija los espacio con que cuenta el Escenario
                          Deportivo
                        </label>
                        <DualListBox
                          options={options}
